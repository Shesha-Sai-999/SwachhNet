console.log("Script.js is running!") // Add this at the top of script.js
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Toggle chatbox visibility - DIRECT IMPLEMENTATION
  ...
  if (chatInput && sendBtn && chatBody) {
    let isBotTyping = false // To prevent multiple simultaneous requests
